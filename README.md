...
- **mkosi.conf** -- Drop-in that enables selftest and fstests build
  profiles, sets RAM/CPU limits for QEMU, and configures the kernel
  command line.
...
ci/mkosi/
  mkosi.conf                 # mkosi drop-in config
